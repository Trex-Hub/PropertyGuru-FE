...
const MoreFilterPopup: React.FC<MoreFilterProps> = ({
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] md:z-50 px-2'>
      <div className='bg-white rounded-3xl shadow-lg w-full max-w-md font-primary h-[90vh]'>
        ...
        <div className='flex p-5 flex-col gap-5 overflow-y-scroll h-[75vh]'>
            ...
            <div className='flex gap-4 text-primary-dropdownIconColor mb-5'>
              {BEDROOM_OPTIONS.map(option => (
                <div
                  key={option.value}
                  className={cn(
                    'border border-primary-dropdownIconColor rounded-sm ',
                    {
        ...
        <div className='w-full bg-primary-settingsBackgroundColor rounded-b-3xl'>
