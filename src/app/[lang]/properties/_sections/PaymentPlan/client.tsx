      ...
      <div
            ...
            <div className='md:flex flex flex-col md:flex-row gap-2 border-b-2 border-b-black py-5 items-top'>
              <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <button
                  ...
                  {selectedFloorPlan
                    ? `${selectedFloorPlan.bedroom} Bed, ${selectedFloorPlan.bathroom} Bath, ${selectedFloorPlan.area !== null ? `${selectedFloorPlan.area} ft²` : 'N/A'}`
                    : 'Select Unit'}
        ...
        {calculatorType === 'mortgage' && (
          <form
            ...
            <div className='flex flex-row justify-between items-center lg:pr-5'>
              <div className='w-1/2 lg:w-auto'>
                <p className='text-xl lg:text-2xl font-bold text-primary-primaryTextColor'>
                  Mortgage Calculator
                </p>
              </div>
              <div className='flex flex-col gap-1 w-1/2 sm:w-auto items-end'>
                <h2 className='text-[0.625rem] md:text-xs text-primary-primaryTextColor px-2 lg:px-0'>
                  Brought To You By
                </h2>
                <Image
                  src='/fablogo.svg'
