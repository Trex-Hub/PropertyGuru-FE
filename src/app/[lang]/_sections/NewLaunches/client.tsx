...
export default function NewLaunchesClient({
  ...
  const section = searchParamsHook.get('section');
  useEffect(() => {
    // Check if the section is 'new-launches'
    if (section === 'new-launches') {
      scrollToElement('new-launches');
    }
  }, [section]);
  return (
    <div
      className='flex flex-col justify-center items-center bg-primary-backgroundColor'
      id='new-launches'>
