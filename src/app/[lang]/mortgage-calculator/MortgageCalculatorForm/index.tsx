...
export default function MortgageCalculatorForm() {
  const formik = useFormik({
    initialValues: {
      ...
      term: process.env.NEXT_PUBLIC_DEFAULT_TERM as string,
      interestRate:
        parseFloat(process.env.NEXT_PUBLIC_DEFAULT_INTEREST_RATE as string) ||
        0,
      downPayment: 0,
      monthlyPayment: 0,
      principal: 0,
    ...
    onSubmit: values => {
      ...
      const totalCost = downPayment + totalInterestPaid + loanAmount;
  ...
  return (
    <div className='bg-primary-backgroundColor rounded-[0.625rem]'>
      <div className='p-3 flex flex-col'>
        <div className='flex flex-row justify-between items-center lg:px-10'>
          <div className='w-1/2 lg:w-auto'>
            <p className='text-xl lg:text-2xl font-bold text-primary-primaryTextColor px-4 lg:px-0'>
              Mortgage Calculator
            </p>
          </div>
          <div className='flex flex-col gap-1 w-1/2 sm:w-auto items-end'>
            <h2 className='text-[0.625rem] md:text-xs text-primary-primaryTextColor px-4 lg:px-0'>
              Brought To You By
            </h2>
            <Image
              src='/fablogo.svg'
        ...
        <form
          ...
          className='flex flex-col gap-3 font-primary my-5 justify-center w-full bg-primary-backgroundGrayMCalc rounded-[0.625rem] py-4 px-6 border border-primary-dropdownInputBorderColor'>
          <div className='md:flex flex flex-col md:flex-row gap-2 border-b border-b-primary-dividerColor py-5 items-top'>
            <div className='md:w-1/2 flex flex-col gap-2'>
              ...
              <div className='flex items-center appearance-none bg-primary-backgroundColor text-sm rounded-xl px-4 py-2 h-[3rem] focus:outline-none text-primary-radioButtonTextColor  justify-between border border-primary-loginBorder'>
                <p className='text-sm text-primary-radioButtonTextColor'>AED</p>
                <Input
                  className='appearance-none border-none text-xl font-bold text-primary-radioButtonTextColor focus:none mr-1 focus-visible:ring-[0.5] bg-primary-backgroundColor'
                  type='text'
                  placeholder=''
                  name='salePrice'
            ...
            <div className='md:w-1/2 flex flex-col gap-5 mt-7'>
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center md:justify-between gap-2'>
                  <div className='flex items-center appearance-none bg-primary-backgroundColor text-sm w-[7.5rem] rounded-xl px-4 py-2 h-[3rem] focus:outline-none text-primary-radioButtonTextColor  justify-between border border-primary-loginBorder'>
                    <Input
              ...
              <div className='flex flex-col gap-5'>
                <div className='md:flex justify-between gap-5'>
                  <div className='flex flex-col gap-1'>
                    ...
                    <div className='bg-primary-backgroundColor text-sm w-full rounded-xl px-4 py-2 h-[3rem] focus:outline-none text-primary-radioButtonTextColor flex justify-between items-center border border-primary-loginBorder'>
                      <Input
                        className='appearance-none border-none focus:none mr-1 focus-visible:ring-[0.5]'
                        type='text'
                        placeholder=''
