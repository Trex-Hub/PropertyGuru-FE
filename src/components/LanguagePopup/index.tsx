...
const LanguagePopup: React.FC<LanguagePopupProps> = ({
    ...
    (
      ...
      const value =
        e.type === 'change'
          ...
          : (e as React.MouseEvent<HTMLLabelElement, MouseEvent>).currentTarget
              .dataset.value;

      if (value) {
        setAreaSystem(value as AreaSystem);
        setAreaChanged(true);
      }
    },
    []
  ...
  const handleDistanceChange = useCallback(
    (
      ...
      if (value) {
        setDistanceSystem(value as DistanceSystem);
  ...
  useEffect(() => {
    if (areaChanged && distanceChanged) {
      // Both settings have been changed, trigger submit action
      window.location.reload();
      // Reset the change flags after triggering the reload
      setAreaChanged(false);
      setDistanceChanged(false);
    }
  }, [areaChanged, distanceChanged]);
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-col ml-1 gap-3'>
                <label
                  ...
                  data-value={AreaSystemConst.SQUARE_FEET}>
                  <input
                    type='radio'
                ...
                <label
                  ...
                  onClick={handleAreaChange}
                  data-value={AreaSystemConst.SQUARE_METRES}>
                  <input
                    type='radio'
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-col ml-1 gap-3'>
                <label
                  ...
                  data-value={DistanceSystemConst.KILO_METERS}>
                  <input
                    type='radio'
                ...
                <label
                  ...
                  onClick={handleDistanceChange}
                  data-value={DistanceSystemConst.MILES_FEET}>
                  <input
                    type='radio'
